...
import { IconDashboard, IconSettings, IconGroup, IconGithub, IconPlugin, IconSun, IconList } from './icons'
...
const menuItems: { id: PageId; label: string; icon: React.ReactNode }[] = [
    ...
    { id: 'rules', label: '规则管理', icon: <IconList size={18} /> },
]
    ...
    return (
        <aside className="w-60 flex-shrink-0 bg-white dark:bg-[#1a1b1d] border-r border-gray-200 dark:border-gray-800 flex flex-col">
            ...
            <div className="px-5 py-6 flex items-center gap-3">
                ...
                <div>
                    <h1 className="font-bold text-sm leading-tight text-gray-900 dark:text-white">Plugin GroupName</h1>
